...
% RESUMEN
\input{Capítulos/abstract}
\clearpage

% AGRADECIMIENTOS
% \input{partes/acknowledgments}
...
\input{Capítulos/introduction}

%CAPÍTULO 2 - ESTADO DEL ARTE
\input{Capítulos/state_of_art}

%CAPÍTULO 3 - DISEÑO CONCEPTUAL
\input{Capítulos/conceptual_design}

%CAPÍTULO X - CONCLUSIONES Y RECOMENDACIONES
\input{Capítulos/conclusions_recommendations}
